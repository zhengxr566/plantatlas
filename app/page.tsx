  ...
  return (
    <AtlasLayout>
      ...
      <p>
        ...
        可以查看植物对比页面；如果你已经知道植物名称，可以进入对应植物页查看科属关系、
        近缘植物和谱系位置。
      </p>

      <div className="home-entry-links">
        <p>
          <Link href="/identify" className="link">
            浏览全部植物识别
          </Link>
          ，按叶片、花果、树皮、季节变化和环境快速判断植物种类。
        </p>
      ...
      <p>
        ...
        对比页面会从分类位置、叶片、花、果实、树皮和生长习性等角度说明区别，
        帮助快速识别相似植物。
      </p>
